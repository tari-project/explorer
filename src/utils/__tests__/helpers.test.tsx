...
describe('helpers', () => {
  ...
  describe('formatHash', () => {
    it('should format hash with default decimals', () => {
      expect(formatHash(1500)).toBe('1.5 KH')
    })

    it('should format hash with custom decimals', () => {
      expect(formatHash(1500, 2)).toBe('1.50 KH')
    })

    it('should handle different suffixes', () => {
      expect(formatHash(500)).toBe('500.0 H')
      expect(formatHash(1500000)).toBe('1.5 MH')
      expect(formatHash(1500000000)).toBe('1.5 GH')
      expect(formatHash(1500000000000)).toBe('1.5 TH')
      expect(formatHash(1500000000000000)).toBe('1.5 PH')
    })

    it('should handle very large numbers', () => {
      expect(formatHash(1500000000000000000)).toBe('1500.0 PH')
    })

    it('should handle zero', () => {
      expect(formatHash(0)).toBe('0.0 H')
    })
  })
