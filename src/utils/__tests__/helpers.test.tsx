...
describe("helpers", () => {
  ...
  describe("powCheck", () => {
    it("should return correct PoW text for RandomX (Merge Mined)", () => {
      expect(powCheck("0")).toContain("RandomX (Merge Mined)");
    });

    it("should return correct PoW text for SHA3x", () => {
      expect(powCheck("1")).toContain("SHA3x");
    });

    it("should return correct PoW text for RandomX", () => {
      expect(powCheck("2")).toContain("RandomX");
    });

    it("should return correct PoW text for Cuckaroo", () => {
      expect(powCheck("3")).toContain("Cuckaroo");
    });

    it("should return Unknown for invalid numbers", () => {
      expect(powCheck("4")).toContain("Unknown");
      expect(powCheck("999")).toContain("Unknown");
      expect(powCheck("")).toContain("Unknown");
    });
  });
