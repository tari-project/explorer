...
describe('SearchKernel', () => {
  ...
  it('should show validation error for invalid nonce length', () => {
    ...
    expect(screen.getByText('Nonce must be a 64-character hash.')).toBeInTheDocument()
  })
  ...
  it('should show validation error for invalid signature length', () => {
    ...
    expect(screen.getByText('Signature must be a 64-character hash.')).toBeInTheDocument()
  })
  ...
  it('should have correct input field properties', () => {
    ...
    expect(signatureInput).toHaveAttribute('placeholder', 'Enter Signature')
  ...
  it('should validate exact 64-character length for hashes', () => {
    ...
    fireEvent.change(nonceInput, { 
      target: { value: '123456789abcdef123456789abcdef123456789abcdef123456789abcdef12' } 
    })
    fireEvent.change(signatureInput, { 
      target: { value: '1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef' } 
    })
    ...
    fireEvent.change(nonceInput, { 
      target: { value: '1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef1' } 
    })
    fireEvent.click(searchButton)
