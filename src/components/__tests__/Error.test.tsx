...
describe('Error', () => {
  ...
  it('should handle long error messages', () => {
    const longMessage = 'This is a very long error message that should still be displayed correctly in the alert component without breaking the layout or accessibility features'
  ...
  it('should handle special characters in message', () => {
    const specialMessage = 'Error: Failed to fetch data (404) - {"error": "Not found"}'
