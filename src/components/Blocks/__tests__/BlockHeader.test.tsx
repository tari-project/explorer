...
vi.mock('@components/StyledComponents', () => ({
  GradientPaper: ({ children, ...props }: any) => <div {...props}>{children}</div>
}))
...
describe('BlockHeader', () => {
  ...
  it('should disable previous button when at block height 0', () => {
    ...
    const prevButton = screen.getByText('Previous Block').closest('button')
  ...
  it('should disable next button when at tip height', () => {
    ...
    const nextButton = screen.getByText('Next Block').closest('button')
  ...
  it('should render correct links for navigation', () => {
    ...
    expect(screen.getByText('All Blocks').closest('a')).toHaveAttribute('href', '/blocks/')
    expect(screen.getByText('Previous Block').closest('a')).toHaveAttribute('href', '/blocks/122')
    expect(screen.getByText('Tip').closest('a')).toHaveAttribute('href', '/blocks/1000')
    expect(screen.getByText('Next Block').closest('a')).toHaveAttribute('href', '/blocks/124')
  })
