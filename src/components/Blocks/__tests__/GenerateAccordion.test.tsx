...
vi.mock('@components/StyledComponents', () => ({
  StyledAccordion: ({ children, expanded, onChange, isHighlighted, ...props }: any) => (
    <div 
      data-testid="styled-accordion" 
      data-expanded={expanded}
      data-highlighted={isHighlighted === undefined ? 'false' : String(isHighlighted)}
...
describe('GenerateAccordion', () => {
  ...
  it('should show expanded state correctly', () => {
    ...
    expect(screen.getByTestId('styled-accordion')).toHaveAttribute('data-expanded', 'true')
  })
  ...
  it('should show collapsed state correctly', () => {
    ...
    expect(screen.getByTestId('styled-accordion')).toHaveAttribute('data-expanded', 'false')
  })
  ...
  it('should apply highlighting when isHighlighted is true', () => {
    ...
    expect(screen.getByTestId('styled-accordion')).toHaveAttribute('data-highlighted', 'true')
  })
  ...
  it('should not apply highlighting when isHighlighted is false', () => {
    ...
    expect(screen.getByTestId('styled-accordion')).toHaveAttribute('data-highlighted', 'false')
  })
  ...
  it('should handle different tab names correctly', () => {
    render(
      <TestWrapper>
        <GenerateAccordion {...defaultProps} tabName="Kernel" adjustedIndex={5} />
      </TestWrapper>
    )
    ...
    const items = [
      {
        ...
        copy: 'parent-copy',
        children: [
          { label: 'Child', value: 'child-val', copy: 'child-copy' }
        ]
      }
    ]
