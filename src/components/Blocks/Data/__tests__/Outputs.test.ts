...
describe('outputItems', () => {
  it('should transform output data into display items', () => {
    ...
    expect(result[1].label).toBe('Commitment')
  })
  ...
  it('should include sender offset public key', () => {
    ...
    const senderOffset = result.find(item => item.label === 'Sender Offset Public Key')
  ...
  it('should include encrypted data', () => {
    ...
    const encryptedData = result.find(item => item.label === 'Encrypted Data')
