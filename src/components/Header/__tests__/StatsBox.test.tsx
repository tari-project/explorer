...
vi.mock('../StatsBox/StatsMobile/StatsMobile', () => ({
  default: ({ 
    ...
    <div data-testid="stats-mobile">
      ...
      <span data-testid="tari-random-x-hash-rate-mobile">{tariRandomXHashRate}</span>
...
describe('StatsBox', () => {
  ...
  it('should render desktop variant with formatted statistics', () => {
    ...
    expect(screen.getByTestId('monero-hash-rate')).toHaveTextContent('12.3TH/s')
    expect(screen.getByTestId('tari-random-x-hash-rate')).toHaveTextContent('5.4TH/s')
  ...
  it('should render mobile variant with formatted statistics', () => {
    ...
    expect(screen.getByTestId('monero-hash-rate-mobile')).toHaveTextContent('12.3TH/s')
    expect(screen.getByTestId('tari-random-x-hash-rate-mobile')).toHaveTextContent('5.4TH/s')
    expect(screen.getByTestId('sha-hash-rate-mobile')).toHaveTextContent('9.9TH/s')
    expect(screen.getByTestId('average-block-time-mobile')).toHaveTextContent('4m')
  ...
  it('should handle missing hash rate data with defaults', () => {
    ...
    expect(screen.getByTestId('tari-random-x-hash-rate')).toHaveTextContent('0H/s')
  ...
  it('should pass all required props to mobile component', () => {
    ...
    expect(screen.getByTestId('tari-random-x-hash-rate-mobile')).toBeInTheDocument()
