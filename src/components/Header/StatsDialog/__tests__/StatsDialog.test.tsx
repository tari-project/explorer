...
vi.mock('@mui/material/DialogContent', () => ({
  default: ({ children, dividers }: { children: React.ReactNode; dividers?: boolean }) => (
...
vi.mock('../StatsDialog.styles', () => ({
  BootstrapDialog: ({ children, open, onClose, 'aria-labelledby': ariaLabelledBy }: any) => (
    open ? (
      <div 
  ...
  StyledDialogTitle: ({ children, id }: { children: React.ReactNode; id: string }) => (
...
describe('StatsDialog', () => {
  ...
  it('should render dialog with proper accessibility attributes', () => {
    ...
    expect(dialog).toHaveAttribute('data-aria-labelledby', 'customized-dialog-title')
