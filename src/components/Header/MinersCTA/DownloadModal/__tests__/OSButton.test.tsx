...
vi.mock('../OSButton.styles', () => ({
  GradientButton: ({ children, onClick }: { children: React.ReactNode; onClick: () => void }) => (
...
describe('OSButton', () => {
  ...
  it('should open Windows download link when clicked', () => {
    ...
    expect(mockWindowOpen).toHaveBeenCalledWith('https://example.com/windows-download', '_blank')
  })
  ...
  it('should open Mac download link when clicked', () => {
    ...
    expect(mockWindowOpen).toHaveBeenCalledWith('https://example.com/mac-download', '_blank')
  })
  ...
  it('should open Linux download link when clicked', () => {
    ...
    expect(mockWindowOpen).toHaveBeenCalledWith('https://example.com/linux-download', '_blank')
  })
  ...
  it('should handle invalid OS gracefully', () => {
    ...
    const { container } = render(<OSButton os="Invalid" />)
