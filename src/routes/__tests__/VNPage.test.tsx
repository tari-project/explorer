...
describe('VNPage', () => {
  ...
  it('should render VN table component', () => {
    render(
      <TestWrapper>
        <VNPage />
      </TestWrapper>
  ...
  it('should render VN table within gradient paper', () => {
    render(
      <TestWrapper>
        <VNPage />
      </TestWrapper>
    ...
    const vnTable = screen.getByTestId('vn-table')
    
    expect(gradientPaper).toBeInTheDocument()
    expect(vnTable).toBeInTheDocument()
    expect(gradientPaper).toContainElement(vnTable)
  })
  ...
  it('should provide correct component structure', () => {
    ...
    // Verify the component hierarchy: Fragment -> Grid -> GradientPaper -> VNTable
    const grid = screen.getByTestId('grid')
    const gradientPaper = screen.getByTestId('gradient-paper')
    const vnTable = screen.getByTestId('vn-table')
  ...
  it('should display validator nodes table', () => {
    render(
      <TestWrapper>
        <VNPage />
      </TestWrapper>
    ...
    const vnTable = screen.getByTestId('vn-table')
    expect(vnTable).toHaveTextContent('VN Table')
  })
})
