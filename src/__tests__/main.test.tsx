...
vi.mock('@tanstack/react-query-devtools', () => ({
  ReactQueryDevtools: (props: any) => 
    <div data-testid="react-query-devtools" data-props={JSON.stringify(props)} />
}))

// Mock react-router-dom
const mockRouter = { routes: [] }
const mockCreateBrowserRouter = vi.fn(() => mockRouter)
vi.mock('react-router-dom', () => ({
  createBrowserRouter: mockCreateBrowserRouter,
  RouterProvider: ({ router }: { router: any }) => 
    <div data-testid="router-provider" data-router={JSON.stringify(router)}>Router</div>
}))
